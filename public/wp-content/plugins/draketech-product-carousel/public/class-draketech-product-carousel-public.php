 ...
 * @subpackage Draketech_Product_Carousel/public
 */
 ...
 */
class Draketech_Product_Carousel_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/draketech-product-carousel-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/draketech-product-carousel-public.js', array( 'jquery' ), $this->version, false );
